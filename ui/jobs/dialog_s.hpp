class WS_GUI_Jobs_S
{
	...
	onLoad = "_this call compile preprocessFileLineNumbers 'ui\jobs\s\init.sqf';";
	...
	class controls
	{
		...
		{
			idc = 1200;
			text = "ui\jobs\s\img\paratrooper.paa";
			x = 0.309171 * safezoneW + safezoneX;
		...
		{
			idc = 1600;
			text = "Coming Soon"; //--- ToDo: Localize;
			x = 0.309171 * safezoneW + safezoneX;
		...
		{
			idc = 1201;
			text = "ui\jobs\s\img\paramedic.paa";
		...
		{
			idc = 1203;
			text = "ui\jobs\s\img\unknown_sol.paa";
